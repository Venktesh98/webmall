...
Route::get('/products/myorders','ProductController@userOrders')->name('products.myorders');
...
Route::get('paypal/checkout-cancel','PayPalController@PayPalCancelPage')->name('paypal.cancel');
